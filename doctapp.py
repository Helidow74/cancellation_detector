...
if __name__ == "__main__":
    ...
    # Call mlflow autolog (enregistre tout ce qui se passe au niveau du serveur)
    mlflow.sklearn.autolog(log_models=False) # We won't log models right away

    # Parse arguments given in shell script (permet d'ajouter des arguments lors du lancement script)
    ...
    # Pipeline (on package notre modèle avec préprocessing inclus)
